    ...
    <div className="h-screen flex flex-col">
      <div className="flex flex-1">
        <aside className="w-72 bg-zinc-950 p-6">
          ...
          <nav className="mt-6 pt-10 border-top border-zinc-800 flex flex-col gap-2">
        ...
        <main className="flex-1 p-6">
          ...
          <h2 className="font-semibold text-2xl mt-10">Made for Julia</h2>
          <div className="grid grid-cols-8 gap-4 mt-4">
            <a
              href="#"
              className="bg-white/5 p-3 rounded-lg hover:bg-white/10 flex flex-col gap-2"
            >
              <Image
                src="/album.jpg"
                width={104}
